            ...
            if (editar)
            {
                try
                {
                        ...
                        | txtCosto.Text.Equals("") | txtVenta.Text.Equals("") | txtEstante.Text.Equals("") | cmbImpuesto.Text.Equals(""))
                    {
                        ...
                        {
                            var tablaP = entity.Producto.FirstOrDefault(x => x.IdProducto == Convert.ToDecimal(id));
                            tablaP.IdProducto = Convert.ToInt32(txtId.Text);
                       ...
                       if (Convert.ToDecimal(txtVenta.Text) > Convert.ToDecimal(txtCosto.Text))
                        {
                            ...
                            tabla.IdProducto = Convert.ToInt32(txtId.Text);
